...
/**
 * add spaces symbol and line break and reduce count of spaces
 */
public class SpacesSymbolLineBreakLower implements IFormatterCommand {
     ...
     */
    public SpacesSymbolLineBreakLower(final CountOfSpaces countOfSpaces, final IToken curToken, final IWriter writer) {
