...
/**
 * add spaces symbol and line break and up count of spaces
 */
public class SpacesSymbolLineBreakUpper implements IFormatterCommand {
     ...
     */
    public SpacesSymbolLineBreakUpper(final CountOfSpaces countOfSpaces, final IToken curToken, final IWriter writer) {
