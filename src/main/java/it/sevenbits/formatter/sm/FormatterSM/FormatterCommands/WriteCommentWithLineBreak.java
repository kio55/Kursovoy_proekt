 ...
 * write comment
 */
public class WriteCommentWithLineBreak implements IFormatterCommand {
     ...
     */
    public WriteCommentWithLineBreak(final CountOfSpaces countOfSpaces, final IToken curToken, final IWriter writer) {
