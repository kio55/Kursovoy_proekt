...
/**
 * add word and line break up count of spaces
 */
public class SymbolLineBreakSpacesUpper implements IFormatterCommand {
     ...
     */
    public SymbolLineBreakSpacesUpper(final CountOfSpaces countOfSpaces, final IToken curToken, final IWriter writer) {
